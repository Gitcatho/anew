...
insert into st_info values (202201, 'LeeGiilDng','Game');
insert into st_info values (202202, 'KimGiilDng','Computer');
insert into st_info values (202203, 'HongGiilDng','Game');
select * from st_info;
